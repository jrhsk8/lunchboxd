...
- `og.png` — the 1200×630 link-preview card referenced by `og:image` in index.html. Generated, not hand-drawn: edit `scripts/og-card.html` and re-run `python scripts/render-og.py`, then commit the PNG.
...
```html
<span
  style="font-family:'Schibsted Grotesk',sans-serif; font-weight:800; letter-spacing:-0.02em; color:#efe9e0;"
  >lunchbox<span style="color:#d98b6a;">d</span></span
>
```
